...
class CardCategorieGetStartingWidgetPhone extends StatefulWidget {
  final TarikhaModel tarikhaModel;

  const CardCategorieGetStartingWidgetPhone(
      {Key? key, required this.tarikhaModel})
      : super(key: key);

  @override
  _CardCategorieGetStartingWidgetPhoneState createState() =>
      _CardCategorieGetStartingWidgetPhoneState();
}

class _CardCategorieGetStartingWidgetPhoneState
    extends State<CardCategorieGetStartingWidgetPhone> {
